  ...
  const eveningMenu = [
    {
      title: "Grill Meat",
      icon: <UtensilsCrossed className="text-[var(--gold)]" size={28} />,
      description: "Het vlees wordt geserveerd in saus naar keuze. Keuze uit champignonsaus, pepperaus, Hollandaisesaus of vierkazenazensaus. Alle grillgerechten worden geserveerd met rijst, groenten & frietjes of aardappelpuree.",
      items: [
        { name: "Steak Entrecote", price: "€27,99", description: "" },
        { name: "Steak Ribeye", price: "€27,99", description: "" },
        { name: "Filet Mignon", price: "€27,99", description: "" },
        { name: "T-Bone Steak", price: "€34,99", description: "" },
        { name: "Spare Ribs", price: "€25,99", description: "" },
        { name: "Lamskotelet", price: "€24,99", description: "" },
        { name: "Lamsspiesjes", price: "€20,50", description: "" },
        { name: "Kipfilet van de Grill", price: "€18,99", description: "" },
        { name: "Manhattan Grill", price: "€32,50", description: "Mix van kipfilet, ketta, worstjes, filet mignon, entrecote, Lamskotelet en spare ribs." },
        { name: "Manhattan Grill 2 Personen", price: "€59,99", description: "Mix van kipfilet, ketta, worstjes, filet mignon, entrecote, lamsskotlet en spare ribs." }
      ]
    },
    {
      title: "Pasta's",
      icon: <UtensilsCrossed className="text-[var(--gold)]" size={28} />,
      description: "Keuze uit; Penne, Spaghetti of tagliatelle. (Alle Pasta's worden geserveerd met Tomatensaus, Roomsaus of beide)",
      items: [
        { name: "Napolitana", price: "€12,50", description: "Tomatensaus met basilicum" },
        { name: "Manhattan", price: "€13,50", description: "Kip, ui, knoflook champignons, roomsaus, basilicum en parmezaanse kaas" },
        { name: "Carbonara", price: "€14,50", description: "Stukjes bacon met roomsous, ui, basilicum en parmezaanse kaas" },
        { name: "Bolognese", price: "€14,50", description: "Een klassieke Bolognese saus van perfect gekruide gehakt en verse tomaten" },
        { name: "Arrabiata", price: "€13,50", description: "Pittige tomatensaus met cherry tomaten, basilicum, knoflook, Spaanse pepers en peterselie" },
        { name: "Alla Pesto", price: "€15,50", description: "Kipfilet, roomsaus, pesto en parmezaanse kaas" },
        { name: "Al Salmon", price: "€16,50", description: "Zalm, roomsaus, spinazie, ui, knoflook en parmezaanse kaas" },
        { name: "Gamberi", price: "€16,50", description: "Garnalen, uien, paprika, knoflook, cherry tomaten en een roomsaus" }
      ]
    },
    {
      title: "Grill Fish",
      icon: <ChefHat className="text-[var(--gold)]" size={28} />,
      items: [
        { name: "Zalm van de Grill", price: "€21,99", description: "" }
      ]
    },
    {
      title: "Schotels",
      icon: <UtensilsCrossed className="text-[var(--gold)]" size={28} />,
      description: "Schotels worden geserveerd met rijst, friet en salade. (Optioneel geserveerd met rijst = €2,50)",
      items: [
        { name: "Hete Kip Schotel", price: "€17,50", description: "" },
        { name: "Kipsaté Schotel", price: "€17,50", description: "" },
        { name: "Kefta Schotel", price: "€17,50", description: "" },
        { name: "Gemarineerde kipvleugels Schotel", price: "€17,50", description: "" }
      ]
    },
    {
      title: "Burgers",
      icon: <UtensilsCrossed className="text-[var(--gold)]" size={28} />,
      items: [
        { name: "Manhattan Burger", price: "€12,50", description: "Dubbele verse homemade burger van ambachtelijk rundvlees met kaas soensnagen, ei, uienringen, sla, augurk, BBQ saus & Big Mac saus" },
        { name: "Hamburger Grill", price: "€8,99", description: "Verse hamburger van ambachtelijk rundvlees met sla, tomaat, augurk, ui & Big Mac saus" },
        { name: "Cheese Burger", price: "€9,50", description: "Verse hamburger van ambachtelijk rundvlees met cheddar kaas, sla, tomaat, augurk, ui & Big Mac saus" },
        { name: "Burger Mexicana", price: "€9,50", description: "Verse homemade burger van ambachtelijk rundervlees met sla, tomaat, ui, cheddarkaas, jalapeno, siracha & Big Mac saus" },
        { name: "Smokey Burger", price: "€10,50", description: "Verse hamburger van ambachtelijk rundvlees met een laagje cheddar kaas, gesmolten kaas, tomaat, augurk, ui & BBQ saus" },
        { name: "Crispy Chicken Burger", price: "€8,50", description: "Crispy chicken burger met sla, tomaat, augurk, cheddar kaas & Big Mac saus" }
      ]
    },
    {
      title: "Salades",
      icon: <UtensilsCrossed className="text-[var(--gold)]" size={28} />,
      items: [
        { name: "Salade Carpaccio", price: "€10,50", description: "Een carpaccio salade met rucola, pijnboompitten, rode ui, pesto, truffelmayonaise, cherrytomaat & Parmezaanse kaas" },
        { name: "Salade Burrata", price: "€10,50", description: "Salade bestaande uit mesclun sla, burrata kaas, pesto, appel, walnoten, vijgen, pijnboompitten & honing" },
        { name: "Caesar Salade", price: "€10,50", description: "Salade bestaande uit mesclun sla, crispy kipfilet, croutons, avocado, huisgemaakte Caesar dressing, cherrytomaat & Parmezaanse kaas" }
      ]
    },
    {
      title: "Sides",
      ...
      items: [
        ...
        { name: "Franse Friet Mayo/Curry/Ketchup/Saté", price: "€4,50", description: "" },
        { name: "Franse Friet Oorlog/Special", price: "€4,50", description: "" },
        { name: "Franse Friet Truffle/Mayonnaise & Parmezaanse Kaas", price: "€7,00", description: "" },
        { name: "Loaded Fries", price: "€7,50", description: "Franse friet met rode chili pepper, bacon, cheddar kaas & huisgemaakte saus" },
        { name: "BBQ Hot Wings 6", price: "€7,50", description: "" },
        { name: "Chicken Nuggets 6", price: "€5,50", description: "" },
        { name: "Dynamite Shrimp Chutney", price: "€12,50", description: "" }
      ]
    },
    {
